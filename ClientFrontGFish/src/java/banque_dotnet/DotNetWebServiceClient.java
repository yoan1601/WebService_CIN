...
public class DotNetWebServiceClient {
    ...
    public static Finance consulteFinance(String idCIN) {
        try {
            ...
            String serviceUrl = "http://localhost:5204/api/Banque/consultationBanque?idCIN="+idCIN;
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
               ...
               // La réponse devrait contenir la somme
                ...
                final Finance finance = gson.fromJson(result, Finance.class);
                return finance;
